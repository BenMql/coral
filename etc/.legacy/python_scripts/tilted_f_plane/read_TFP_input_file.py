...
def read_params_file():
   return open("TFP_parameters.in","r").readlines()
...
def read_iekman():
   list_of_parameters = read_params_file()
   line_of_interest = [x for x in list_of_parameters if '1/Ek' in x]
...
def read_Lbox_Y():
   list_of_parameters = read_params_file()
   line_of_interest = [x for x in list_of_parameters if 'y/z aspect ratio' in x]
   return float( line_of_interest[0].partition(" ")[0].replace('d','e')) 
...
def read_latitude():
   list_of_parameters = read_params_file()
   line_of_interest = [x for x in list_of_parameters if 'Latitude' in x]
   return float( line_of_interest[0].partition(" ")[0].replace('d','e')) 

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
def read_upright_bool():
   list_of_parameters = read_params_file()
   line_of_interest = [x for x in list_of_parameters if 'Upright' in x]
