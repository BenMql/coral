...
u = np.fromfile(path2file+'var001_'+Zstr+'_'+tstr+'_full.dat', dtype=np.float_).reshape(NYAA, NXAA)
v = np.fromfile(path2file+'var002_'+Zstr+'_'+tstr+'_full.dat', dtype=np.float_).reshape(NYAA, NXAA)
w = np.fromfile(path2file+'var003_'+Zstr+'_'+tstr+'_full.dat', dtype=np.float_).reshape(NYAA, NXAA)
T = np.fromfile(path2file+'var004_'+Zstr+'_'+tstr+'_full.dat', dtype=np.float_).reshape(NYAA, NXAA)
