...
WHERE_TO=/data/cavity/R10P1_L1_ell0p1_B01
...
ln -s ${CORAL_ROOT}/build/craik_ribbon.x ${WHERE_TO}/.
ln -s ${CORAL_ROOT}/etc/python_scripts/*.py  ${WHERE_TO}/.
cp    ${CORAL_ROOT}/etc/input_files_examples/CLR_parameters.in  ${WHERE_TO}/.
