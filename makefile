...
PENCILS_LEGACY_2DECOMP  = $(CORAL_ROOT)/src/pencils.legacy/
...
pencils2.0: $(Layer_pencil_Objects)
	...
	$(MAKE) clean
                        ...
                        ##########################
                        ##########################
# ~~~~~~~~~~~~~~~~~~~   #  LAYER PENCILS, LEGACY #  ~~~~~~~~~~~~~~~~~~~
                        ##########################
                        ##########################


Layer_pencil_legacy_Objects := $(MISC_SRC)chdir_mod.o    
Layer_pencil_legacy_Objects += $(MISC_SRC)fortran_kinds.o
Layer_pencil_legacy_Objects += $(MISC_SRC)read_command_line_args.o
Layer_pencil_legacy_Objects += $(FFTW_SRC)fftw3_wrap.o
Layer_pencil_legacy_Objects += $(TEXT_SRC)cwraps.o
Layer_pencil_legacy_Objects += $(TEXT_SRC)cfun_parse_text.o
Layer_pencil_legacy_Objects += $(TEXT_SRC)ftext_parsing.o
Layer_pencil_legacy_Objects += $(MPI_SRC)MPI_vars.o
Layer_pencil_legacy_Objects += $(OUT_SRC)output_misc.o          
Layer_pencil_legacy_Objects += $(MISC_SRC)timeKeeping.o
Layer_pencil_legacy_Objects += $(MISC_SRC)time_mpi.o
Layer_pencil_legacy_Objects += $(TSTEP_SRC)IMEX_schemes.o
Layer_pencil_legacy_Objects += $(MISC_SRC)read_command_line_args.o
Layer_pencil_legacy_Objects += $(MISC_SRC)include_git_version.o
Layer_pencil_legacy_Objects += $(MISC_SRC)wallclock.o
Layer_pencil_legacy_Objects += $(PENCILS_LEGACY_2DECOMP)domain_decomposition.o
Layer_pencil_legacy_Objects += $(LAYER)PL_geometry.o
Layer_pencil_legacy_Objects += $(LAYER)PL_cheby_misc.o
Layer_pencil_legacy_Objects += $(MISC_SRC)include_git_version.o
Layer_pencil_legacy_Objects += $(CHEBY_SRC)lapack_module.o
Layer_pencil_legacy_Objects += $(LAYER)PL_string_to_data.o
Layer_pencil_legacy_Objects += $(LAYER)PL_equations.o             
Layer_pencil_legacy_Objects += $(SPARSE_SRC)sparse_formats_d.o
Layer_pencil_legacy_Objects += $(SPARSE_SRC)sparse_formats_z.o
Layer_pencil_legacy_Objects += $(SPARSE_SRC)sparse_formats.o
Layer_pencil_legacy_Objects += $(SPARSE_SRC)sparse_conversions.o
Layer_pencil_legacy_Objects += $(SPARSE_SRC)sparse_blas.o
Layer_pencil_legacy_Objects += $(SPARSE_SRC)sparse_manipulations.o
Layer_pencil_legacy_Objects += $(CHEBY_SRC)chebyshev_elementary.o
Layer_pencil_legacy_Objects += $(CHEBY_SRC)chebyshev_galerkin_2.o
Layer_pencil_legacy_Objects += $(LAYER)PL_algebra_d_1D.o
Layer_pencil_legacy_Objects += $(LAYER)PL_algebra_z_1D.o
Layer_pencil_legacy_Objects += $(LAYER)PL_algebra_z_3D.o
Layer_pencil_legacy_Objects += $(LAYER)PL_algebra.o             
Layer_pencil_legacy_Objects += $(PENCILS_LEGACY_2DECOMP)transforms.o
